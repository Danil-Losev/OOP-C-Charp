...
namespace Task1
{
    internal class Magazine : Edition, IRateAndCopy, IEnumerable
    {
        ...
        public Magazine(string name, Frequency frequency, System.DateTime releaseDate, int circulation, ArrayList articles = null, ArrayList editors = null)
        {
            Name = name;
            Frequency = frequency;
        ...
        public object DeepCopy()
        {
            ...
            foreach (Person person in Editors)
            {
                editorsCopy.Add(person.DeepCopy());
            }
